...
if ( function_exists( 'wp_cache_add' ) ) {
	echo '<strong>ERROR:</strong> wp_cache_add already exist. Contact <a href="https://closte.com">closte.com</a>';  
	exit(1);
} else { 
	...
	function wp_cache_init() {
		if ( ! function_exists( 'apcu_fetch' ) ) {
            ...
            echo '<strong>ERROR:</strong> APCu does not exist. Contact <a href="https://closte.com">closte.com</a>';
			exit( 1 );
		}
